...
class RAGService:
    ...
    Attributes:
        ...
        hybrid_search_database: ベクトルデータベースクラスのインスタンス
        logger: ロガー
    """
    def __init__(
        self, 
        ...
        self.hybrid_search_database = hybrid_search_database

        # データベースの初期化
        try:
            self.hybrid_search_database.initialize_database()
    ...
    def get_document_count(self) -> int:
        ...
        try:
            # ドキュメント数を取得
            count = self.hybrid_search_database.get_document_count()
    ...
    def index_documents(
        ...
        try:
            ...
            self.hybrid_search_database.batch_insert_documents(documents)
        ...
        try:
            ...
            if with_context and context_size > 0:
                ...
                for result in results:
                    ...
                    # 前後のチャンクを取得
                    adjacent_chunks = self.hybrid_search_database.get_adjacent_chunks(file_path, chunk_index, context_size)
                ...
                if full_document:
                    ...
                    for result in all_results:
                        ...
                        # ファイルの全文を取得
                        full_doc_chunks = self.hybrid_search_database.get_document_by_file_path(file_path)
    ...
    def clear_index(self) -> Dict[str, Any]:
        ...
        try:
            ...
            deleted_count = self.hybrid_search_database.clear_database()
